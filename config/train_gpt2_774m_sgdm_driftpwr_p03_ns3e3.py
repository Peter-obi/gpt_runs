...
# Use with: python train.py config/train_gpt2.py config/train_gpt2_774m_sgdm_driftpwr_p03_ns3e3.py

optimizer_type = 'sgd'
out_dir = 'out-gpt2-774m-sgdm-driftpwr-p03-ns3e3'
wandb_run_name = 'gpt2-774m-sgdm-driftpwr-p03-ns3e3'
dataset = '/content'
